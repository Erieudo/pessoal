...
<div class="empty-account-page">
    <div class="container">
        ...
        <div class="row message ">
             <center>Utilize o xml gerado da planilha excel.</center>
        </div>
...
if ($conn){
    ...
    $sql = "CREATE TABLE IF NOT EXISTS TORCEDOR (
...
    <label> <input type='file' name='arquivo'class='form-control-file'></label>
