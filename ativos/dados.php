...
if(!empty($_FILES['arquivo']['tmp_name'])){
	$xml = simplexml_load_file($_FILES['arquivo']['tmp_name']);
      ...
      foreach ($xml as $key => $value){
        ...
        $sqlarray = array($value['nome'],$value['documento'],$value['cep'],$value['endereco'],$value['bairro'],$value['cidade'],$value['uf'],$value['telefone'],$value['email'],$value['ativo']);
...
<div class="empty-account-page">
    <div class="container">
        <div class="row congratz">
            <h1>Concluido <a href="http://www.appsolution.tk/">Início</a> </h1><i></i>
