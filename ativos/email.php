...
<div class="empty-account-page">
    <div class="container">
        <div class="row congratz">
            <h1>E-mail (enviar para todos)</h1><i></i>
        ...
        <div class="row message">
            ...
            <div class="form-group">
                <label >Mensagem</label>
                   ...
                   <textarea name ="mensagem"class="form-control" rows="3"required="required"></textarea>
              </div>
...
if(!empty($_POST['assunto'])){
    $consulta = $conn->query("SELECT NOME, EMAIL FROM TORCEDOR;");
    if($consulta->rowCount()>0){
        echo '<div class="alert alert-primary"">
          <center><h1> <a href="http://appsolution.tk/"> Início</a></h1></center>
          </div>
        ';
        ...
        while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
         ...
         echo "Sem e-mail(s)cadastrado(s). ";
     }
